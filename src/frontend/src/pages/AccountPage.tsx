      ...
      <div className="container mx-auto px-4 py-20 text-center">
        ...
        <div className="flex flex-col items-center gap-3 max-w-xs mx-auto">
          ...
          <button
            type="button"
            onClick={login}
            data-ocid="account.google_signin.button"
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 hover:shadow-md transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500"
          >
            <GoogleIcon />
            Continue with Google
          </button>
